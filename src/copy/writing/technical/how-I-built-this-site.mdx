...
The code for this site is <a href="https://github.com/willm30/portfolio">public on Github</a>. Please take a look if there's anything I've mentioned you'd like to replicate specifically, and leave me a comment if you'd like to know more about anything I've mentioned—or if you see rooom for improvement!