...
My work with Gatsby is primarily client-focused. While there are a few opportunities to write for the Node runtime, such as when using Gatsby APIs, I'm generally writing client-side code. This means that my knowledge of server-side programming is weaker than I'd like it to be, and I'm keen at some point in the future to code my own server on some small, personal projects instead of relying on Gatsby.

## WebGL and ThreeJS

WebGL is a javascript API for working with 3D graphics in the browser, and ThreeJS is a library that permits the creation of 3D planes of motion. I'm really keen to improve my animation skills, and these two libraries lend themselves perfectly to creating websites that radiate luxury. 
